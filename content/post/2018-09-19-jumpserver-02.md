...
![图片描述](https://pic.fenghong.tech/tapd_23280401_base64_1537346899_31.png)
...
![图片描述](https://pic.fenghong.tech/tapd_23280401_base64_1537346915_59.png)
```
登录名为：您的英文名（全小写）。
密码为：您刚设置的密码。
```
![图片描述](https://pic.fenghong.tech/tapd_23280401_base64_1537346932_41.png)
...
点击下一步--->
	跳过google应用--->
		点击下一步---->
```
![图片描述](https://pic.fenghong.tech/tapd_23280401_base64_1537346943_80.png)
...
![图片描述](https://pic.fenghong.tech/tapd_23280401_base64_1537346966_26.png)
...
![图片描述](https://pic.fenghong.tech/tapd_23280401_base64_1537337395_70.png)

## 1.2 修改密码

在个人信息页面点击"更改密码"按钮，跳转到修改密码页面，正确输入新旧密码，即可完成密码修改:

![图片描述](https://pic.fenghong.tech/tapd_23280401_base64_1537337414_83.png)
