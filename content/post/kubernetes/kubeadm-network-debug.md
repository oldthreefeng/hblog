...
[知乎专栏](https://www.zhihu.com/people/feisky/posts)
...
如果 kube-dns 处于 CrashLoopBackOff 状态，那么可以参考 [Kube-dns/Dashboard CrashLoopBackOff 排错](https://link.zhihu.com/?target=https%3A//kubernetes.feisky.xyz/zh/troubleshooting/cluster.html) 来查看具体排错方法。
...
如果 kube-dns service 不存在，或者 endpoints 列表为空，则说明 kube-dns service 配置错误，可以重新创建 [kube-dns service](https://link.zhihu.com/?target=https%3A//github.com/kubernetes/kubernetes/tree/master/cluster/addons/dns)，比如
...
欢迎关注《[Kubernetes指南](https://link.zhihu.com/?target=https%3A//github.com/feiskyer/kubernetes-handbook)》开源书。

## 参考文档

- [Troubleshoot Applications](https://link.zhihu.com/?target=https%3A//kubernetes.io/docs/tasks/debug-application-cluster/debug-application/)
- [Debug Services](https://link.zhihu.com/?target=https%3A//kubernetes.io/docs/tasks/debug-application-cluster/debug-service/)